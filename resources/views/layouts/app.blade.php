                    ...
                    <div class="dark:bg-gray-900 dark:text-gray-100 bg-gray-100 grid grid-cols-2 px-10 py-5">
                        ...
                        <div class="col-span-2 flex">
                            ...
                            <div class="flex items-center mt-5">
                                ...
                                <label
                                    class="uppercase md:text-sm text-xs dark:text-white text-gray-500 text-light font-semibold">Nombre
                                    de
                                    usuario</label>
                            </div>
                        </div>
                                ...
                                <label class="">
                                    <div class="flex items-center">
                                        <div> <input type="checkbox" name="remember"
                                                ...
                                                class="appearance-none form-check-inline focus:ring-2 focus:border-indigo-400 border-indigo-400 text-indigo-500checked:bg-indigo-400" />
                                        </div>
                                        <div class="label-checked:bg-red-600 text-sm ml-2.5">Mantener activa mi sesión
                                        </div>
                                    </div>
                                </label>
                            </div>
