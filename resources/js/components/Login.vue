<template>
  <div class="transition delay-150 ease-in-out py-10 flex items-center justify-center">
    <div class="bg-gray-900 absolute inset-0 z-10 opacity-70"></div>
    <img class="absolute inset-0 h-full w-full" src="http://1.bp.blogspot.com/-8EQn0ho5be0/VUv4fdM4l0I/AAAAAAAAAJQ/1h5i7hRX6V4/s1600/FB_IMG_1431018149564.jpg" alt="">
    <div class="dark:bg-gray-900 dark:text-gray-200 bg-gray-100 grid px-10 py-8 grid-cols-2 z-50">
      ...
      <div class="col-span-2 mt-2">
        ...
        <div v-if="errors.username" class="flex gap-1 items-center mt-1 mb-1 transition duration-300 ease-in-out">
          ...
          <p class="dark:text-red-400 text-red-500 text-sm">{{ errors.username[0] }}</p>
        </div>
      </div>
      ...
      <div class="col-span-2 mt-2">
        ...
        <div v-if="errors.username" class="flex gap-1 items-center mt-1 mb-1 transition duration-300 ease-in-out">
          ...
          <p class="dark:text-red-400 text-red-500 text-sm">{{ errors.password[0] }}</p>
        </div>
      </div>
